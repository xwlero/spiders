...
class Crack():
    def __init__(self, zhanghao):
        ...
        self.browser = webdriver.Chrome('d:/chromedriver.exe', options=chrome_options)
        self.wait = WebDriverWait(self.browser, 100)
        #初始边界值
        self.BORDER = 6
        self.passwd = zhanghao[1]
        self.username = zhanghao[0]
        ...
        while 1:
            # 保存的图片名字
                ...
                if self.browser.current_url == self.url:
                    ...
                    break
        c1 = self.browser.get_cookies()
        c2={}
        for i in c1:
            c2[i['name']]=i['value']
        self.browser.close()
        coo=[c2,[self.username,self.passwd]]
        return coo